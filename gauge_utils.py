...
def init_gauge_with_gauge(model_name, flag=0):
    ...
    if flag == 0:
        ...
        with (open('/home/test/program/self-driving/testing/cache/Chauffeur/train_outputs/layer_bounds_bin.pkl', 'rb')
              as f):
            layer_bounds_bins = pickle.load(f)
        with (open('/home/test/program/self-driving/testing/cache/Chauffeur/test_outputs/knc_coverage_cache.pkl', 'rb')
              as f):
